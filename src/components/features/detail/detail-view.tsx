    ...
    <div className="min-h-screen pb-28">
      ...
      <main className="mx-auto w-full max-w-7xl px-4 py-4 space-y-4 sm:px-6 sm:py-6 lg:px-8">
        <div className="grid gap-4 lg:grid-cols-3">
          {/* Left column: main transaction card (spans 2 on large) */}
          ...
          {/* Right column: verification + info + OCR */}
          <div className="space-y-4 lg:col-span-1">
            ...
            {receipt.ocrText && (
              <Card className="overflow-hidden">
                ...
                <pre className="max-h-64 overflow-y-auto whitespace-pre-wrap p-4 font-mono text-[11px] leading-relaxed text-muted-foreground scrollbar-thin">
                  {receipt.ocrText}
                </pre>
              </Card>
            )}
