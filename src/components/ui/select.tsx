    ...
    <SelectPrimitive.Portal>
      ...
      >
        ...
        <SelectPrimitive.Viewport
          className={cn(
            "p-1.5 bg-white dark:bg-slate-900",
            position === "popper" &&
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "focus:bg-blue-50 focus:text-blue-600 dark:focus:bg-slate-800 dark:focus:text-blue-400 relative flex w-full cursor-pointer items-center gap-2 rounded-lg py-2 pr-8 pl-3 text-xs font-semibold outline-none select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 text-slate-800 dark:text-slate-200 bg-white dark:bg-slate-900",
        className
      )}
      {...props}
    >
